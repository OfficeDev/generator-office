    ...
    copyFiles: function () {
      try {
        ...
        if (this.project.isExcelFunctionsProject) {
          this.fs.copyTpl(this.templatePath(`Excel Custom Functions (Preview)/manifest.xml`), this.destinationPath(`${this.project.projectInternalName}-manifest.xml`), templateFills);
          }
        else {
