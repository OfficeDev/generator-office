...
export const testConfigurationErrorEventName: string = "test-data-configuration-error-generator-office";
export const testCopyFilesErrorEventName: string = "test-data-copy-files-error-generator-office";
export const testInstallDependenciesErrorEventName = "test-data-install-dependencies-error-generator-office";
export const testPromptSelectionsErrorEventName: string = "test-data-prompt-selections-error-generator-office";
